...
//					
		...
		tableheading=new String[] {"DOCUMENT","PHONE NUMBER","NAME","GENDER","COUNTRY","ROOM","CHKTIME","DEPOSITE"};
		tabledata=Helper.LoadData.loadData("Customer",Helper.LoadData.tableRowCount("Customer"),8);
		table = new JTable();
